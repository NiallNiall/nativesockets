...
var bubbleColour = '#00506e';
var bubbleColourPink = '#ffc1c9';
var totalBubbles = 60;
...
function createBubble(initialPos) {
    ...
    function setBubbleStroke(strokeSize) {
        bubbleShape.strokeColor = '#33a0be';
        bubbleShape.strokeWidth = strokeSize;
    }
    ...
    var bubble = {
      ...
      setBubbleStroke: setBubbleStroke,
...
window.onload = function() {
    ...
    paper.view.onFrame = function(event) {
       ...
       for(var i=0; i <= bubbles.length-1; i ++) {
            ...
            bubble1.setBubbleStroke(testInput/8);
